...
<x-guest bg="{!!$bg!!}">
    ...
    <div class="grid grid-cols-2 gap-4 lg:flex xs:hidden">
        <div>
            <img src="{{asset('/storage/images/icon_home/sport2.png')}}" class="w-full animate-bounce">
        </div>
        <div class=" animate-bounce">
            <img src="{{asset('/storage/images/icon_home/sport.png')}}" class="w-full">
        </div>
    </div>
    ...
    <div>
        <b class="text-4xl">24IBOOM <b class="text-4xl text-yellow-700"> SPORTS</b></b><p> เว็บพนันที่รวบรวมเกมทุกชนิด มาให้คุณแล้วที่นี่ที่เดียว </p>
    </div>
