                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">
                                        คุณต้องการทำรายการแลกเครดิตใช่หรือไม่ ?</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-red-500">คะแนนของคุณ : {{ $pointUser }}</p>
                                        <p class="text-sm text-gray-500">คะแนนที่คุณต้องการจะแลก : {{ $pointExchange }}</p>
                                        <p class="text-sm text-green-500">เครดิตที่คุณจะได้รับ : {{ $creditExchange }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button wire:click="saveToDatabase" type="button"
                            ...
                            <button wire:click="closeModaConfrimExchange" type="button"
