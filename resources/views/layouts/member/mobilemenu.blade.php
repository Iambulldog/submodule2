...
<div>
    @if (Auth::user())
    <div
    class="rounded-lg  grid grid-cols-5 fixed  gap-4 text-sm   bottom-0 md:hidden items-center text-center text-black bg-gradient-to-b from-[rgba(114,116,119,0)] from-25%  via-black to-black  ">

    <div class="">
        <a href="{{ route('member.pocket.home') }}" class="">
            ...
            <span class="text-yellow-400">กระเป๋า</span>
        </a>
    </div>

    <div class="">
        <a href="{{ route('member.deposit') }}" class="">
            <div class="flex justify-center">
                <img src="{{ asset('storage/images/depo.png') }}" class="w-14">
            </div>
            <span class="text-yellow-400">ฝาก</span>
        </a>
    </div>
    <div class="">
        <a href="{{ url('/game', ['product' => 'Casino']) }}" class="">
            <div class="flex justify-center animate-bounce">
                <img src="{{ asset('storage/images/game.png') }}" class="-translate-y-1 hover:-translate-y-3   "
                    alt="">
            </div>
            <span class="text-lg text-yellow-400 ">เข้าเล่น</span>
        </a>
    </div>
    <div class="">
        <a href="{{ url('withdraw') }}" class="">
            <div class="flex justify-center">
                <img src="{{ asset('storage/images/with.png') }}" class="w-14">
            </div>
            <span class="text-yellow-400">ถอน</span>
        </a>
    </div>
        ...
        <a href="{{ route('member.logout') }}"
            ...
            <div class="flex justify-center">
                <svg class="w-14 hover:-translate-y-1" viewBox="0 0 512 512" fill="{{ $style['colorIcon'] }}">
                    <g>
                        <path class="st0"
                            d="M423.262,91.992c-16.877-15.91-43.434-15.098-59.32,1.778c-15.894,16.877-15.098,43.434,1.779,59.32
                        ...
                        <path class="st0"
                            d="M256,268.59c23.178,0,41.967-15.033,41.967-33.574V33.574C297.967,15.033,279.178,0,256,0
                        c-23.178,0-41.967,15.033-41.967,33.574v201.443C214.033,253.557,232.822,268.59,256,268.59z" />
                    </g>
                </svg>
            </div>
            <span class="text-yellow-400">logout</span>
        </a>
    ...
    <div class="">
        <a href="{{ route('casino') }}" class="">
            <div class="flex justify-center">
                <img src="{{ asset('storage/images/icon_home/casino_home.png') }}" class="w-14">
            </div>
            <span class="text-yellow-400">คาสิโน</span>
        </a>
    </div>

    <div class="">
        <a href="{{ route('slot') }}" class="">
            <div class="flex justify-center">
                <img src="{{ asset('storage/images/icon_home/game_home.png') }}" class="w-14">
            </div>
            <span class="text-yellow-400">เกมส์</span>
        </a>
    </div>
    <div class="">
        <a href="{{ route('sport') }}" class="">
            <div class="flex justify-center animate-bounce">
                <img src="{{ asset('storage/images/icon_home/sport_home.png') }}" class="-translate-y-1 hover:-translate-y-3   "  alt="">
            </div>
            <span class="text-lg text-yellow-400 ">กีฬา</span>
        </a>
    </div>
    <div class="">
        <a href="{{ route('promotions') }}" class="">
            <div class="flex justify-center">
                <img src="{{ asset('storage/images/icon_home/pro_home.png') }}" class="w-14">
            </div>
            <span class="text-yellow-400">โปรโมชั่น</span>
        </a>
    </div>
    ...
    <div class="">
        <a href="{{ route('blog.list') }}" class="">
            <div class="flex justify-center">
                <img src="{{ asset('storage/images/icon_home/ari_home.png') }}" class="w-14">
            </div>
            <span class="text-yellow-400">บทความ</span>
        </a>
